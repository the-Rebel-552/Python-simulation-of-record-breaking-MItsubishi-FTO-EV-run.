...
"""
  Comments — #---hidden for the finale
    ...
    To calculate an unknown acceleration time (for example, the acceleration time to 130 km/h when
    you know the acceleration to 100 km/h):
      you need to open (#---hidden for the finale) in the calc_non_uniform_accel_distance function, set more intervals
      and then do the acceleration calculations according to the instructions:
        ...
        to do this, you need to take the last segment of acceleration to 100 and count how many times
        it will reach the required speed and multiply by a time slightly greater than the time of the same segment
